    ...
    <div class="custom_table shadow-sm">
      <div class="custom_table_header p-3 bg--dark radius-top shadow-sm border bg-light">
        <div class="row m-0">
          ...
          <div class="col-md-2 bold d-none d-md-inline text-weight-bold">Nom de utilisateur</div>
          ...
          <div class="col-md-2 bold d-none d-md-inline">Role</div>
      ...
      <div class="custom_table_body">
          ...
          <div class="ctb_item col-md-2 mb-2 mb-sm-0">Role</div>
