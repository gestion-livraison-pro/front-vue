                                    ...
                                    <ul class="list-unstyled latest-message-list mb-0">
                                        <li class="message-list-item">
                                            <a href="#" class="text-dark">
                                                <div class="d-flex">
                                                    <img class="me-3 avatar-sm rounded-circle" src="/src/assets/images/users/avatar-2.jpg" alt="">
                                                    <div class="">
                                        ...
                                        <li class="message-list-item">
                                            <a href="#" class="text-dark">
                                                <div class="d-flex">
                                                    <img class="me-3 avatar-sm rounded-circle" src="/src/assets/images/users/avatar-3.jpg" alt="">
                                                    <div class="">
                                        ...
                                        <li class="message-list-item">
                                            <a href="#" class="text-dark">
                                                <div class="d-flex">
                                                    <img class="me-3 avatar-sm rounded-circle" src="/src/assets/images/users/avatar-4.jpg" alt="">
                                                    <div class="">
                                        ...
                                        <li class="message-list-item">
                                            <a href="#" class="text-dark">
                                                <div class="d-flex">
                                                    <img class="me-3 avatar-sm rounded-circle" src="/src/assets/images/users/avatar-5.jpg" alt="">
                                                    <div class="">
                                                        <h6 class="mt-0">Danny Benson</h6>
                                ...
                                <div class="p-2 mt-2">
                                    <ul class="list-unstyled latest-message-list mb-0">
                                        ...
                                        <li class="message-list-item">
                                            <a href="#" class="text-dark">
                                                <div class="d-flex">
                                                    <img class="me-3 avatar-sm rounded-circle" src="/src/assets/images/users/avatar-6.jpg" alt="">
                                                    <div class="">
                                                        <h6 class="mt-0">Danny Benson</h6>
                                                        <p class="text-muted mb-0">I've finished it! See you so...</p>
                                        ...
                                        <li class="message-list-item">
                                            <a href="#" class="text-dark">
                                                <div class="d-flex">
                                                    <img class="me-3 avatar-sm rounded-circle" src="/src/assets/images/users/avatar-7.jpg" alt="">
                                                    <div class="">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <img src="/src/assets/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle me-2"> Rafael Reardon
                                            </div>
                                        </td>
                                        <td>14/10/2018</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <img src="/src/assets/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle me-2"> Thomas Hirsch
                                            </div>
                                        </td>
                                        <td>15/10/2018</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <img src="/src/assets/images/users/avatar-4.jpg" alt="" class="avatar-xs rounded-circle me-2"> Archer Desaillly
                                            </div>
                                        </td>
                                        <td>15/10/2018</td>
                                        <td><span class="badge bg-success">Delivered</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <img src="/src/assets/images/users/avatar-5.jpg" alt="" class="avatar-xs rounded-circle me-2"> Michael Flannery
                                            </div>
                                        </td>
                                        <td>16/10/2018</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <img src="/src/assets/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle me-2"> Jamie Fishbourne
                                            </div>
                                        </td>
                                        <td>17/10/2018</td>
                                        <td><span class="badge bg-success">Delivered</span></td>
