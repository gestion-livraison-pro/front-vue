...
<template>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title mt-0" id="myModalLabel">Modifier Tarif</h5>
          ...
          <div class="modal-body">
            ...
            <SelectDropdown :value="formData.LivreurId" apiUrl="https://api.gestion-livraison.pro/api/deliverymans"
              fieldName="Nom" first_option="Selectionner un Client" label="Livreurs" Class_Content="col-md-12 mt-4"
              @update:value="formData.LivreurId = $event" />
  ...
  <div id="modalAdd" class="modal fade" tabindex="-1" aria-labelledby="modalAdd" aria-hidden="true">
    <form @submit.prevent="submitFormAdd">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title mt-0" id="modalAdd">Nouvelle Tarif</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
  ...
  <Supprimer :apiUrl="`https://api.gestion-livraison.pro/api/deliveryman/fees/${delete_row_id}/delete`"
...
export default {
  ...
  methods: {
    ...
    async submitFormUpdate() {
      const CityCodeID = this.formData.id; // Retrieve the customer ID from the URL

      const return_data = await updateData(`https://api.gestion-livraison.pro/api/deliveryman/fees/${CityCodeID}/update`, this.formData);
      this.formData = {
        id: '',
        LivreurId: '',
        VilleId: '',
    ...
    async submitFormAdd() {
      const res = await addData("https://api.gestion-livraison.pro/api/deliveryman/fees/new", this.formData);
      this.formData = {
        id: '',
        LivreurId: '',
        VilleId: '',
