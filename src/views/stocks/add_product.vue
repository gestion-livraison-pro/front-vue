...
import { addData, getRole, updateDataPost } from '../../composition/crud.js';
...
export default {
    ...
    methods: {
        async submitForm() {
            ...
            await updateDataPost("https://api.gestion-livraison.pro/api/product/new", this.formData);
        },
