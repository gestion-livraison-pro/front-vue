    ...
    <div class="page-content">
      <div class="container-fluid">
        ...
        <form @submit.prevent="submitForm">
          <div class="row">
            <div class="col-md-8">
              <table_add_bon apiUrl="https://api.gestion-livraison.pro/api/bon/return/customer/orders" @table-data="handleTableData"  :filters_update="query_search" />
            </div>
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      await addData("https://api.gestion-livraison.pro/api/bon/customer/return/new", formData);
    },
