      ...
      <div class="container-fluid">
        ...
        <form @submit.prevent="submitForm">
          <div class="row">
            <div class="col-md-8">
              <table_add_bon
  apiUrl="https://api.gestion-livraison.pro/api/bon/return/customer/orders"
  @table-data="handleTableData"
  :updateSelected="`https://api.gestion-livraison.pro/api/bon/${bonID}/customer/return/get`" :filters_update="query_search"
/>            </div>
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      await updateData(`https://api.gestion-livraison.pro/api/bon/${this.bonID}/customer/return/update`, formData);
    },
