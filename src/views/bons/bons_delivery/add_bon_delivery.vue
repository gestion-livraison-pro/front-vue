    ...
    <div class="page-content">
      <div class="container-fluid">
        <heading pageTitle="Nouveau Bon de Livraison" />
          <div class="row">
            <div class="col-md-8">
              <table_add_bon apiUrl="https://api.gestion-livraison.pro/api/bon/delivery/orders"
                @table-data="handleTableData" :filters_update="query_search" />
            </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 mt-4">
                      <button_simple @click="submitForm" Class_Content="col-md-12 mt-4" btn_text="Ajouter Bon de livraison" />
...
import { addData, GenerateBonPdf } from '../../../composition/crud.js';
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      const response = await addData("https://api.gestion-livraison.pro/api/bon/delivery/new", formData);
      if(response.data.id){
