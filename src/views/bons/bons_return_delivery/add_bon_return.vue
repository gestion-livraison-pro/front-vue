    ...
    <div class="page-content">
      <div class="container-fluid">
        ...
        <form @submit.prevent="submitForm">
          <div class="row">
            <div class="col-md-8">
              <table_add_bon apiUrl="https://api.gestion-livraison.pro/api/bon/return/delivery/orders" @table-data="handleTableData"  :filters_update="query_search" />
            </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 mt-4">
                      <button_simple type="submit" Class_Content="col-md-12 mt-4" btn_text="Ajouter le Bon Retour" />
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      const formData = {
        deliverymanId: this.filters.driver,
        selectedRows: this.selectedOrders,
        colis: this.selectedOrders.length,
      };

      await addData("https://api.gestion-livraison.pro/api/bon/delivery/return/new", formData);
    },
